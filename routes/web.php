...
Route::get('/berita', [BeritaController::class, 'show'])->middleware(['auth', 'verified'])->name('berita.show');
...
Route::delete('/berita/hapus', [BeritaController::class, 'destroy'])->middleware(['auth', 'verified'])->name('berita.hapus');
